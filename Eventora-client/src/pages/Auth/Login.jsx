...
import { FaGoogle, FaArrowLeft, FaEye, FaEyeSlash, FaEnvelope, FaLock, FaUserSecret, FaUser } from "react-icons/fa";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-base-200 relative overflow-hidden p-4">
      ...
      <motion.div 
        ...
        className="bg-base-100 w-full max-w-5xl h-auto md:min-h-[600px] rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col md:flex-row relative z-10"
      >
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 lg:p-16 flex flex-col justify-center bg-base-100">
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              <h3 className="text-3xl font-bold font-serif text-base-content mb-1">Welcome Back!</h3>
              <p className="text-base-content/60 text-sm">Please enter your details.</p>
            </div>
            
            {/* Quick Demo Buttons (New Requirement) */}
